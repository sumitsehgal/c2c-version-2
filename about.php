                ...
                <div class="cor about-sp">
                    <div class="ed-about-tit">
                        <div class="con-title">
                            ...
                            <p>Core2Creations LLP is an organisation that provides Education, IT services, Consulting and Business solutions. It covers all levels of education including basics to advance. Any IT solution can be deal by us. It focus on the latest IT technologies So that these can be distribute in the society to learn and use. The goal of the company is to make the human life easier by using technologies in their daily life and work. we literate people and make them able to produce and grab new job opportunities.</p>
                        </div>
                    </div>
                    <div class="ed-about-sec1" style="display: none;">
                        <div class="ed-advan">
                            <ul>
                                <li>
                                    <div class="ed-ad-img">
