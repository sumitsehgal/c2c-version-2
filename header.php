...
<head>
    <title>Core2Creations LLP</title>
    <!-- META TAGS -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Core2Creations LLP is an organisation that provides Education, IT services, Consulting and Business solutions. It will cover all levels of education including basics to advance. Any IT solution will be taken care by the organisation. It will focus on the latest IT technologies So that these can be distribute in the society to learn and use. The goal of the company is to make the human life easier by using technologies in their daily life and work. It will literate people and make them able to produce and grab new job opportunities.">
    <meta name="keyword" content="education, university, college, school, online education, tution center, coaching, industrial training, jobs, technologies">
        ...
        <div class="ed-mob-menu">
            <div class="ed-mob-menu-con">
                <div class="ed-mm-left">
                    <div class="wed-logo">
                        <a href="index.php"><img src="images/core.png" alt="" />
                        </a>
                    </div>
                </div>
                <div class="ed-mm-right">
                    <div class="ed-mm-menu">
                        ...
                        <div class="ed-mm-inn">
                           ...
                           <!--  <h4>All Courses</h4>
                            <ul>
                                <li><a href="course-details.html">Computer Industrial Training</a></li>
                                <li><a href="course-details.html">Computer Basic Course</a></li>
                                <li><a href="course-details.html">Computer Advance Course</a></li>
                            </ul> -->
                            <!-- <h4>User Account</h4>
                            <ul>
                            ...
                            <ul>
                                ...
                                <li><a href="event-register.html">Event register</a></li> --><!-- Future -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="ed-com-t1-left">
                            <ul>
                                <li><a href="#">Contact: #2249, Vishwakarma Colony, Jagadhri</a>
                                </li>
                                <li><a href="#">Phone: +91-7988929968</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="ed-com-t1-social">
                            <ul>
                                <li><a href="https://www.facebook.com/core2creations" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                </li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="main-menu">
                            <ul>
                                    ...
                                    <div class="mm-pos">
                                        <div class="about-mm m-menu">
                                            <div class="m-menu-inn">
                                                ...
                                                <p>Want to change the world? At Core2Creations we’re doing just that. When you join the Golden Bear community, you’re part of an institution that shifts the global conversation every single day.</p>
                                        ...
                                        <div class="admi-mm m-menu">
                                            <div class="m-menu-inn">
                                                ...
                                                <div class="mm2-com mm1-com mm1-s1">
                                                    ...
                                                    <p>An educated man should know everything about something, and something about everything.</p>
                                                    <a href="admission.html" class="mm-r-m-btn">Read more</a>
                                                </div>
                                                <div class="mm2-com mm1-com mm1-s1" style="display: none;">
                                                    <div class="ed-course-in">
                                                ...
                                                <div class="mm2-com mm1-com mm1-s4"  style="display: none;">
                                                    <div class="ed-course-in">
                                ...
                                <li class="cour-menu" style="display: none;">
                                    ...
                                    <div class="mm-pos" >
                                        ...
                                        <div class="mm1-com mm1-cour-com mm1-s3">
                                           ...
                                           <ul>
                                              ...
                                              <li><a href="admin-courses.php">All courses</a></li>
